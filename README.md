...
The only goal of this sample is to compile all the required config and common
...
![Mario](https://github.com/Nauja/ue4-pixelperfect-sample/raw/master/Content/Textures/T_Mario.png)
